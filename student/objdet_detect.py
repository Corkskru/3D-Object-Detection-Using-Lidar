...
def load_configs_model(model_name='darknet', configs=None):
    ...
    if model_name == "darknet":
        ...
        configs.K = 50
        configs.pretrained_path = '/home/workspace/tools/objdet_models/resnet/pretrained/fpn_resnet_18_epoch_300.pth'
        configs.heads = {
...
def create_model(configs):
    ...
    #model.load_state_dict( torch.load(configs.pretrained_filename, strict=False) )
    #model.load_state_dict( torch.load('/home/workspace/SFA3D/checkpoints/fpn_resnet_18/fpn_resnet_18_epoch_300.pth', map_location='cpu') )
